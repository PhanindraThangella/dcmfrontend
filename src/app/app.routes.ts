...
export const routes: Routes = [
    ...
    // {path:'admin',component:DashboardHomeComponent},
    ...
    {path:'manager',component:ManagerDashboardHomeComponent,canActivate:[authGuard],data:{ role: ['MANAGER']}},
    {path:'tagGenerator',component:TagGeneratorHomeComponent,canActivate:[authGuard],data:{ role: ['TAGGENERATOR']}},
];
